#Note: This is almost the exact code for the sphero.py from the SDK, with one small change on line 34.
#On line 34, the RVR is told to turn around for negative speed input. By commenting out the heading change,
#the robot instead moves backwards with the same heading when input speed is negative.
